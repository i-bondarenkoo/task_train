...
# foo()
# print("outside:", x)
# переменные находятся в разных пространствах имен, одно внутри функции, другое глобально в пространстве имен модуля(файла) practice.py
# при вызове первого принта выведется 20, при вызове второго 10
# -------------------------------------------
# x = 10
...
# внутри функции указываем, что переменная х будет ссылать на глобальное имя, которое содержит 10
# затем  этой глобальной переменной присваивается ссылка на новое число 20
#  в результате внутри функции принт выведет 20, и после выполнения функции тоже выведет 20, т.к мы сделали ссылку внутри функции
# глобальной и присвоили новое значение. Ответ 20/20\
# def outer():
#     x = 10
